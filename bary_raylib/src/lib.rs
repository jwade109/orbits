...
pub mod ops {
    ...
    pub use crate::sim::systems::set_all_thrusters;
    pub use crate::sim::systems::set_grid_pose;
    pub use crate::sim::systems::set_grid_vel;
    pub use crate::sim::systems::set_primary_computer_state;
    pub use crate::sim::systems::set_primary_computer_state_c;
    pub use crate::sim::systems::set_primary_computer_waypoint;
    pub use crate::sim::systems::set_primary_computer_waypoint_c;
    pub use crate::sim::systems::set_thruster_state;
