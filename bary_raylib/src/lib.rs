...
pub mod query {
    pub use crate::sim::blueprint_by_id;
    pub use crate::sim::closest_grid;
    pub use crate::sim::get_grid_physical_props;
    pub use crate::sim::get_grid_physical_props_by_id;
    pub use crate::sim::get_sum_linear_forces;
    pub use crate::sim::grid_by_name;
    pub use crate::sim::grid_origin;
    pub use crate::sim::primary_computer_id;
    pub use crate::sim::proto_by_name;
