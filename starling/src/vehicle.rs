...
pub fn load_parts_from_dir(path: &Path) -> HashMap<String, PartProto> {
    ...
    if let Ok(paths) = std::fs::read_dir(path) {
        for path in paths {
            if let Ok(path) = path {
                if let Some(part) = part_from_path(&path.path()) {
                    dbg!(&part);
...
// pub const TANK11: PartProto = PartProto::new(10, 10, PartLayer::Internal, "tank11".to_string());
// pub const TANK21: PartProto = PartProto::new(10, 20, PartLayer::Internal, "tank21".to_string());
// pub const TANK22: PartProto = PartProto::new(20, 20, PartLayer::Internal, "tank22".to_string());
// pub const FRAME: PartProto = PartProto::new(10, 10, PartLayer::Structural, "frame".to_string());
// pub const FRAME2: PartProto = PartProto::new(10, 10, PartLayer::Structural, "frame2".to_string());
// pub const FRAME22: PartProto = PartProto::new(20, 20, PartLayer::Structural, "frame22".to_string());
// pub const FRAME3: PartProto = PartProto::new(40, 10, PartLayer::Structural, "frame3".to_string());
// pub const MOTOR: PartProto = PartProto::new(16, 25, PartLayer::Internal, "motor".to_string());
// pub const ANTENNA: PartProto = PartProto::new(50, 27, PartLayer::Internal, "antenna".to_string());
// pub const SMALL_ANTENNA: PartProto =
//     PartProto::new(6, 20, PartLayer::Internal, "small-antenna".to_string());
// pub const CARGO: PartProto = PartProto::new(30, 30, PartLayer::Internal, "cargo".to_string());
// pub const BATTERY: PartProto = PartProto::new(9, 9, PartLayer::Internal, "battery".to_string());
// pub const CPU: PartProto = PartProto::new(8, 9, PartLayer::Internal, "cpu".to_string());
// pub const SOLARPANEL: PartProto =
